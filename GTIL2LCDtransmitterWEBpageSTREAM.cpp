// Dave Demos 05/28/2023
// cent0 06/01/2023
//do you habe removed otiginal code ?
//i have apply little mod to page Web
// the web page update no need time update but cycle loop reading.
// if use time client.println("Refresh: 5"); // refresh the page automatically every 5 sec is possible load vaule 
//you should use a send every number of readings and not wait time 5 seconds.sometimes this way you might get errors in the web page 
//sometimes you get ac voltage values ​​higher than 1000V and all other data as well.
//help :D
...
// Display current readings 
            ...
            client.print(F("<p><h2><font size=6><font color=black>CONSUMO: "));
            client.print(Load);
            client.print(F(" Watts"));
            client.println(F("</font></h2></p>"));    
